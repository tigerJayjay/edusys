...
<head id="MyHead">
    ...
    $(function(){
    	 $.post("/es_manager/usermanager/getCol",{},function(res){
 	    	$.each(res.rows,function(i,e){
 	    		if("${course.colNo}"==e.colNo)
 	    			$("#colNo").append("<option selected value="+e.colNo+">"+e.colName+"</option>")
 	    		else
 	    ...
 	    $.post("/es_manager/course/getCourseTypes",{},function(res){
 	    	$.each(res.rows,function(i,e){
 	    		if("${course.couseno}"==e.couseno)
 	    			$("#couseno").append("<option selected value="+e.couseno+">"+e.typeName+"</option>");
 	    		else
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/course/updateCourse" ,//url,
    ...
    <fieldset>
        ...
        <div class="bigdiv">
	        ...
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="courseNo" name="courseNo" type="text" value="${course.courseNo }" />
	        </div>
	        <div class="editor-label">
	       ...
	       <div class="editor-label">
            ...
            <div class="editor-field">
	            <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="courseName" name="courseName" type="text" value="${course.courseName}" />
	        </div>
	          <div class="editor-label">
                <label for="credit">学分</label>
            </div>
            <div class="editor-field">
	            <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="credit" name="credit" type="text" value="${course.credit}" />
	        </div>
	        <div class="editor-label">
                <label for="weektime">周学时</label>
            </div>
            <div class="editor-field">
	           <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="weektime" name="weektime" type="text" value="${course.weektime}" />
	        </div>
	         <div class="editor-label">
                <label for="totaltime">总学时</label>
            </div>
            <div class="editor-field">
	           <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="totaltime" name="totaltime" type="text" value="${course.totaltime}" />
	        </div>
	  		 <div class="editor-label">
                <label for="des">备注</label>
            </div>
            <div class="editor-field">
	           <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="des" name="des" type="text" value="${course.des}" />
	        </div>
