...
<html>
<head id="MyHead">
<title>添加课程教材信息</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<script src="/es_manager/resources/Scripts/jquery.min.js"
	type="text/javascript"></script>
<script src="/es_manager/resources/Scripts/JScriptCommon.js"
	type="text/javascript"></script>
<link href="/es_manager/resources/Content/StyleSheet.css"
	rel="stylesheet" type="text/css" />
<script src="/es_manager/resources/Scripts/jquery.validate.min.js"
	type="text/javascript"></script>
<script
	src="/es_manager/resources/Scripts/jquery.validate.unobtrusive.min.js"
	type="text/javascript"></script>
<link href="/es_manager/resources/Content/IndexStyle.css"
	rel="stylesheet" type="text/css" />
<script src="/es_manager/resources/Res/easyui/jquery.easyui.min.js"
	type="text/javascript"></script>
<script
...
<script type="text/javascript">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/courseBook/addCourseBook" ,//url,
...
<body>
	...
	<div class="mbx">添加课程教材</div>
	<form action="#" method="post" onsubmit="return false" id="form1">
		<fieldset>
			<legend>
				<input class="submitcss" type="submit" onclick="login()" id="submit"
					value="保存" /> <input class="submitcss" type="button"
					onclick="BackList('/es_manager/examSchedule/courseBook.jsp')"
					value="返回" />
			</legend>
			<div class="bigdiv">
				...
				<div class="editor-field">
					<input class="text-box single-line" data-val="true"
						data-val-length="长度不可超过36" data-val-length-max="36" id="courseNo"
						name="courseNo" type="text"/>
				</div>
				<div class="editor-label">
					<label for="bookNo">教材号</label>
				</div>
				<div class="editor-field">
					<input id="bookNo" name="bookNo" type="text"> 
				</div>
				 <div class="editor-label">
