...
<head id="MyHead">
    ...
    $(function(){
 	    ...
 	    function grade(){
 	    	...
 	    	if(month>7){
 	    		for(var i = year-3;i<=year;i++){
 	    			if("${schedule.grade}"==i)
 	    			$("#grade").append("<option selected value='"+i+"'>"+i+"</option>");
 	    			else
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/schedule/updateSchedule" ,//url,
...
<form action="#" method="post" onsubmit="return false" id="form1">
    <fieldset>
        ...
        <div class="bigdiv">
        	<input type="hidden" id="scheNo" name="scheNo" value="${schedule.scheNo }">
            <div class="editor-label">
               	<label for="courseNo">课程号</label>
        	</div>
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="courseNo" name="courseNo" type="text" value="${schedule.courseNo}" />
	        </div>
	        <div class="editor-label">
               	<label for="jobno">教师工号</label>
        	</div>
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="jobno" name="jobno" type="text" value="${schedule.jobno}" />
	        </div>
	        <div class="editor-label">
                <label for="place">上课地点</label>
            </div>
            <div class="editor-field">
	          <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="place" name="place" type="place" value="${schedule.place}" />
	        </div>
	         <div class="editor-label">
	       ...
	       <div class="editor-label">
            ...
            <div class="editor-field">
	            <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="startWeek" name="startWeek" type="text" value="${schedule.startWeek}" />
	        </div>
	          <div class="editor-label">
                <label for="endWeek">结束周</label>
            </div>
            <div class="editor-field">
	            <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="endWeek" name="endWeek" type="text" value="${schedule.endWeek}" />
	        </div>
	          <div class="editor-label">
                <label for="weekno">周几</label>
            </div>
            <div class="editor-field">
	            <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="weekno" name="weekno" type="text" value="${schedule.weekno}" />
	        </div>
	         <div class="editor-label">
            ...
            <div class="editor-field">
	           <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="capacity" name="capacity" type="text" value="${schedule.capacity}" />
	        </div>
	         <div class="editor-label">
