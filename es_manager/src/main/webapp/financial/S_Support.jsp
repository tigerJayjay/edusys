        ...
        $(function () {
            ...
            $('#flexigridData').datagrid({
               ...
               // url: 'S_COST_LIST/GetData', //GetDataStudent获取数据的url
                ...
                queryParams: { searchCondition:"{'parentType':'4'}"},
                sortName: 'fcId',
                sortOrder: 'desc',
                idField: 'fcId',
                loadMsg:'数据载入中,请稍后...',
                ...
                columns: [[
                	...
                	{field:"fcIncomePay",title:"应付金额",width:80},
                	{field:"fcDiscount",title:"实付金额",width:80},
                	...
                	{field:"fcChargePerson",title:"付款人",width:80},
...
//            //var SysMenuId = '201212031501329375000b277965adc';
...
//                var arr = rows[0].PK_ID;
            ...
            //window.parent.showIdWindow("打印管理", url, 800, 550, false, false, true);
                ...
                $.post("ReceiptBill/getRbInfo",{bianhao:rows[0].SCL_SerialNumber},function(res){
                    ...
                    else
                    {
                         ...
                         $("#shoukuanren").html(rows[0].SCL_JBR);
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                window.location.href = "S_Support/Details/" + arr[0].PK_ID;
        ...
        function flexiCreate() {
            ...
            window.location.href = "S_Support/Create";
            return false;
        }
        //导航到修改的按钮
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "S_Support/Edit/" + arr[0].PK_ID;
        ...
        function flexiDelete() {
            ...
            $.messager.confirm('操作提示', "确认删除这 " + arr.length + " 项吗？", function (r) {
                if (r) {
                    $.post("S_Support/Delete", { query: arr.join(",") }, function (res) {
                        if (res == "OK") {
                            //移除删除的数据
                            $("#flexigridData").datagrid("reload");
                            $("#flexigridData").datagrid("clearSelections");
...
<style type="text/css" media="print">
	...
	<div id="title" ><span id="shoujutitle">支出凭据</span></div>
    <div id="content">
    	<ul>
        	<li id="left"><span>其他支出单据</span></li>
            <li id="right">
