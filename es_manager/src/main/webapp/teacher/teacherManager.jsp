...
<script type="text/javascript" language="javascript">
        ...
        $(function () {
            ...
            $('#flexigridData').datagrid({
                ...
                collapsible: true,
                singleSelect: true,
                url: '/es_manager/teachermanager/getTea', //获取数据的url
                sortName: 'Id',
                sortOrder: 'desc',
                idField: 'Id',
 				toolbar:'#search',
                columns: [[
					...
					, { field: 'nativeplace', title: '<label for="nativeplace">籍贯</label>', width: 100 }
					, { field: 'phone', title: '<label for="phone">手机号</label>', width: 226
					},{field: 'college', title: '<label for="college">学院</label>', width: 226}
					, { field: 'maxdegree', title: '<label for="maxdegree">最高学历</label>', width: 100 },
					{ field: 'birthdate', title: '<label for="birthdate">生日</label>', width: 226 ,formatter:function(date){
					...
					{ field: 'gender', title: '<label for="gender">性别</label>', width: 100,
					 ...
					 {field: 'entrytime', title: '<label for="entrytime">入职时间</label>', width: 226 ,formatter:function(date){
						    var dt = new Date(date).format("yyyy-MM-dd"); 
							return dt.toString();
					 }},
					 {field: 'maritalstatus', title: '<label for="maritalstatus">婚否</label>', width: 226 ,formatter:function(data){
						 if(data==0){
							 return '未婚';
						 }else{
							 return '已婚';
			...
			<tr>
				<td>
					<form id="queryCondition">
						工号： <input name="jobno" id="jobno" type="text" style="width: 80px">
						&nbsp;&nbsp;姓名： <input name="tname" id="tname" type="text"
							style="width: 80px"> 
							性别： 
						<select name="gender">
						...
						婚否： <select name="maritalstatus">
							<option value="0">未婚</option>
							<option value="1">已婚</option>
						</select> 
						
						</select>
						&nbsp;&nbsp;入职日期&nbsp; <input type="text" width="80"
							id="entrytimeStart" name="entrytimeStart" class="easyui-datebox"
							style="width: 100px" /> <span>到</span> <input type="text"
							id="entrytimeEnd" name="entrytimeEnd" class="easyui-datebox"
