...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/teachermanager/insertAward" ,//url,
...
<form action="#" method="post" onsubmit="return false" id="form1">
    <fieldset>
        ...
        <div class="bigdiv">
	        ...
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="workName" name="workName" type="text" value="${role.roleStatus }" />
	        </div>
            ...
            <div class="editor-field">
	            <input class="easyui-datebox" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="awardtime" name="awardtime" type="text" value="${role.roleStatus }" />
	        </div>
