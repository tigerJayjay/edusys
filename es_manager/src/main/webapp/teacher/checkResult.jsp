            ...
            $('#flexigridData').datagrid({
                ...
                idField: 'Id',
 				...
 				columns: [[
   						...
   						, { field: 'checkContent', title: '<label for="checkContent">考评内容</label>', width: 100 },
   						 {field: 'countsYouxiu', title: '<label for="countsYouxiu">优秀</label>', width: 226}
   						, { field: 'countsLianghao', title: '<label for="countsLianghao">良好</label>', width: 100 },
   						 {field: 'countsZhongdeng', title: '<label for="countsZhongdeng">中等</label>', width: 226}
				...
				<td>
					<form id="queryCondition">
						...
						&nbsp;&nbsp;姓名： <input name="tname" id="tname" type="text"
							style="width: 80px">
							课程号： <input name="couresNo" id="courseNo" type="text"
							style="width: 80px">
						...
						学期：<select id="termtime" name="termtime">
						 ...
						 考评内容：<input name="checkContent" id="checkContent" type="text" style="width: 160px">
