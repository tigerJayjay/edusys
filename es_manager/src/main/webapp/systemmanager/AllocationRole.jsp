    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#flexigridData').datagrid({
                title: ' 当前角色是：报名处权限  ',
                iconCls: 'icon-site',
                url: '/es_manager/User/AllocationUserRole?userId='+$("#CurrentUserID").val(),
                idField: 'roleId',
                rownumbers: true,
                ...
                columns: [[
                    	...
                    	{ field: 'roleName', title: '角色列表', width: 1304
                                        , formatter: function (value, rec) {
                                        	console.log(value);
                                        	console.log(rec);
                                            if (value) {
                                          		if(rec.mark!='0'){
                                          			return '<input id="' + rec.roleId + '" type="checkbox" checked>' + (value);
                                          		}else{
                                          			return '<input id="' + rec.roleId + '" type="checkbox">' + (value);
                                          		}
        ...
        function getView() {
            ...
            $.post("/es_manager/User/saveUserRole", { userId: $("#CurrentUserID").val(), ids: datas }, function (res) {
                if (res == "OK") {
        ...
        function flexiModify() {
            window.location.href = "/es_manager/systemmanager/SysPerson.jsp";
            return false;
        };
    </script>
