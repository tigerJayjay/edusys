    ...
    <fieldset>
        ...
        <div class="bigdiv">
	        ...
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="account" name="account" type="text" value="" />
	        </div>     
	        ...
	        <div class="editor-field">
	            <input  class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="password" name="password" type="password" value="" />
	        </div>
	        
	         <div class="editor-label">
               	<label for="roleNo">角色</label>
        	</div>
	        <div class="editor-field">
	            <select id="roleNo" name="roleNo"></select>
	        </div>
        </div>
    </fieldset>
