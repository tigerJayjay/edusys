...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/bookPayInfo/updateBooPayInfo" ,//url,
...
<form action="#" method="post" onsubmit="return false" id="form1">
    <fieldset>
        ...
        <div class="bigdiv">
        	<input name="no" id="no" value="${payInfo.no}" style="display:none">
            <div class="editor-label">
               	<label for="bookno">书号</label>
        	</div>
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="bookno" name="bookno" type="text" value="${payInfo.bookno}" />
	        </div>
	        <div class="editor-label">
                <label for="sno">学号</label>
            </div>
            <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="sno" name="sno" type="text" value="${payInfo.sno }" />
	        </div>
	         <div class="editor-label">
                <label for="amount">缴费</label>
            </div>
            <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="amount" name="amount" type="text" value="${payInfo.amount}" />
	        </div>
	       <div class="editor-label">
