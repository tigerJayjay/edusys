...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/bookOrder/insertBookOrder" ,//url,
...
<form action="#" method="post" onsubmit="return false" id="form1">
    <fieldset>
        <legend>
            ...
            <input class="submitcss" type="button" onclick="BackList('/es_manager/book/bookBuyInfo.jsp')" value="返回" />
        </legend>
        <div class="bigdiv">
            ...
            <div class="editor-field">
	            <input class="easyui-numberbox" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="number" name="number" type="text" value="${role.roleStatus }" />
	        </div>
	         <div class="editor-label">
	       ...
	       <div class="editor-label">
            ...
            <div class="editor-field">
	           	<select name="yeartime" id="yeartime"></select>
	        </div>
	        <div class="editor-label">
                <label for="totalPrice">总价</label>
            </div>
            <div class="editor-field">
	            <input class="easyui-numberbox" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="totalPrice" name="totalPrice" type="text" value="${role.roleStatus }" />
	        </div>
	         <div class="editor-label">
                <label for="price">单价</label>
            </div>
            <div class="editor-field">
	            <input class="easyui-numberbox" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="price" name="price" type="text" value="${role.roleStatus }" />
	        </div>
    </fieldset>
