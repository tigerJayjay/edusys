...
<script type="text/javascript" language="javascript">
 ...
 $('#flexigridData').datagrid({
                 ...
                 collapsible: true,
                 singleSelect: true,
                 url: '/es_manager/bookOrder/getBookOrder', //获取数据的url
                 sortName: 'Id',
                 sortOrder: 'desc',
                 idField: 'Id',
  				toolbar:'#search',
  			  columns: [[
  			           { field: 'no', title: '<label for="no">序号</label>'}
  						, { field: 'bookNo', title: '<label for="bookNo">书号</label>', width: 226 }
    						, { field: 'bookName', title: '<label for="bookName">书名号</label>', width: 226
  						},{field: 'number', title: '<label for="number">数量</label>', width: 226},
  						{field: 'termtime', title: '<label for="termtime">学期</label>', width: 226},
  						{field: 'yeartime', title: '<label for="yeartime">学年</label>', width: 226},
  						{field: 'totalprice', title: '<label for="totalprice">总价</label>', width: 226},
  						{field: 'price', title: '<label for="price">单价</label>', width: 226}
