...
<script type="text/javascript" language="javascript">
        ...
        $(function () {
            ...
            $('#flexigridData').datagrid({
                ...
                collapsible: true,
                singleSelect: true,
                url: '/es_manager/classRoom/getUsableclassRoom', //获取数据的url
                sortName: 'Id',
                sortOrder: 'desc',
                idField: 'Id',
 				toolbar:'#search',
 				columns: [[
 				          { field: 'NO', title: '<label for="NO">编号</label>'}
 	   						...
 	   						,{field: 'BUILDINGNO', title: '<label for="BUILDINGNO">几号楼</label>', width: 226}
 	   						, { field: 'TOWERNO', title: '<label for="TOWERNO">几座</label>', width: 100 },
			...
			<tr>
				<td>
					<form id="queryCondition">
						开始周-结束周： <input name="startWeek" id="startWeek" type="text" style="width: 80px">
						- <input name="endWeek" id="endWeek" type="text"
							style="width: 80px">
						周几： <select id="weekth" name="weekth">
	            ...
	            <select name="jie" id="jie">
					 ...
					 <a href="javascript:flexiCreate();" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">申请教室</a>&nbsp;&nbsp;
					</form>
