...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/usermanager/addStu" ,//url,
...
<form action="#" method="post" onsubmit="return false" id="form1">
    <fieldset>
        <legend>
            ...
            <input class="submitcss" type="button" onclick="BackList('studentManager.jsp')" value="返回" />
        </legend>
        <div class="bigdiv">
	        ...
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="sno" name="sno" type="text" value="${role.roleName }" />
	        </div>     
	        ...
	        <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="sname" name="sname" type="text" value="${role.roleStatus }" />
	        </div>
            ...
            <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="entranceTime" name="entranceTime" type="text" value="${role.roleStatus }" />
	        </div>
            ...
            <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="grade" name="grade" type="text" value="${role.roleStatus }" />
	        </div>
	         <div class="editor-label">
                <label for="classname">班级</label>
            </div>
            <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="classname" name="classname" type="text" value="${role.roleStatus }" />
	        </div>
	         <div class="editor-label">
