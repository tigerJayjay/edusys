...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/examArrange/insertExamArrangeOne" ,//url,
    ...
    <fieldset>
        ...
        <div class="bigdiv">
	       ...
	       <div class="editor-label">
            ...
            <div class="editor-field">
	            <input class="easyui-numberbox" data-options="min:1,max:18,required:true" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="weekth" name="weekth" type="text" value="${role.roleStatus }" />
	        </div>
	          <div class="editor-label">
                <label for="weekno">周几</label>
            </div>
            <div class="editor-field">
	            <input class="easyui-numberbox" data-options="min:1,max:7,required:true" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="weekno" name="weekno" type="text" value="${role.roleStatus }" />
	        </div>
	        <div class="editor-label">
            ...
            <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="examPlace" name="examPlace" type="text" value="${role.roleStatus }" />
	        </div>
