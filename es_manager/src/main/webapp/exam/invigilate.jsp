...
<script type="text/javascript" language="javascript">
 ...
 $('#flexigridData').datagrid({
  			  ...
  			  columns: [[
					...
					{ field: 'jobno', title: '<label for="jobno">教师工号</label>', width: 100 },
        ...
        function flexiCreate() {
            window.location.href = "/es_manager/exam/addInvigilate.jsp";
            return false;
        }
        function flexiCreateFast(){
        	 window.location.href = "/es_manager/exam/addExamArrangeFast.jsp";
             return false;
        }
        //导航到修改的按钮
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "/es_manager/invigilate/toModifyInvigilate?no="+arr[0].NO;
            } else {
        ...
        function flexiDelete() {
            ...
            $.messager.confirm('操作提示', "确认删除这 " + rows.length + " 项吗？", function (r) {
                if (r) {
                    $.post("/es_manager/invigilate/deleteInvigilate", {invigilateNo:no}, function (res) {
                        if (res.status == "200") {
                            //移除删除的数据
			...
			<tr>
				<td>
					<form id="queryCondition">
						...
						&nbsp;&nbsp;工号： <input name="tno" id="tno" type="text"
							style="width: 80px"> 
