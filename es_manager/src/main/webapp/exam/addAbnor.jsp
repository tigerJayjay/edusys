...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/examAbnormal/insertExamAbnormal" ,//url,
    ...
    <fieldset>
        ...
        <div class="bigdiv">
	       ...
	       <div class="editor-label">
            ...
            <div class="editor-field">
	            <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="recordtime" name="recordtime" type="text" value="${role.roleStatus }" />
	        </div>
	          <div class="editor-label">
                <label for="recordno">记录人工号</label>
            </div>
            <div class="editor-field">
	            <input class="text-box single-line"  data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="recordno" name="recordno" type="text" value="${role.roleStatus }" />
	        </div>
	        <div class="editor-label">
