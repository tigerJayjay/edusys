...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/examArrange/updateExamArrangeDetail" ,//url,
...
<form action="#" method="post" onsubmit="return false" id="form1">
    <fieldset>
        <legend>
            ...
            <input class="submitcss" type="button" onclick="BackList('/es_manager/exam/examArrangeDetail.jsp')" value="返回" />
        </legend>
        <div class="bigdiv">
            ...
            <div class="editor-field">
	            <input class="text-box single-line" data-val="true" data-val-length="长度不可超过36" data-val-length-max="36" id="sno" name="sno" type="text" value="${arrangeDetail.sno}" />
	        </div>
            ...
            <div class="editor-field">
	            <input class="easyui-numberbox"  data-val-length="长度不可超过36" data-val-length-max="36" id="seatNumber" name="seatNumber" type="text" value="${arrangeDetail.seatNumber}" />
	        </div>
            <div class="editor-field">
	            <input id="no" name="no" value="${arrangeDetail.no}" type="hidden">
	        </div>
	        </div>
    </fieldset>
