...
<head id="MyHead">
   ...
   function login() {
            ...
            //几个参数需要注意一下
                ...
                url: "/es_manager/examArrange/insertExamArrangeDetail" ,//url,
...
<form action="#" method="post" onsubmit="return false" id="form1">
    <fieldset>
        ...
        <div class="bigdiv">
            ...
            <div class="editor-field">
	            <input class="easyui-numberbox"  data-val-length="长度不可超过36" data-val-length-max="36" id="seatNumber" name="seatNumber" type="text" value="${role.roleStatus }" />
	        </div>
            <div class="editor-field">
	            <input id="examno" name="examno" type="hidden" value="<%=request.getParameter("examno") %>" />
	        </div>
	        </div>
    </fieldset>
